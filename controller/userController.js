...
const placeOrder = async (req, res) => {
  try {
    ...
    console.log(req.body,'its ur bod');
...
console.log(appliedCouponCode,'its ur coupondidioi');
    ...
    // Ensure total is calculated after applying coupon
    const totalAmount = subtotal - couponDiscount;
    console.log('Total after coupon discount:', totalAmount);
...
const orderSummary = async (req, res) => {
  try {
    ...
    res.render('orderSummary', { 
      order, 
      subtotal,
      finalTotal,  // Pass the correct total to the view
      error: null
    });
  } catch (error) {
    console.error(error);
